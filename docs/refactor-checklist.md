...
- [x] 2.4 移动 sinks 业务逻辑
- [x] 2.5 更新 stat.rs 和 validate.rs 使用新实现
...
- [x] 3.1 分析现有调用链
- [x] 3.2 移除 obs::stat 包装层
- [x] 3.3 将 sink 统计移到 business 层
- [x] 3.4 更新所有调用点
- [x] 3.5 更新集成测试
- [x] 3.6 运行测试验证
- [x] 3.7 提交阶段 3 更改
...
- [x] 4.1 规划目录结构
- [x] 4.2 创建 utils 目录结构
- [x] 4.3 移动 connectors 到 business 层
- [x] 4.4 移动 validate 到 business/observability
- [x] 4.5 删除 obs 目录
- [x] 4.6 更新 lib.rs 和导入路径
- [x] 4.7 编译验证
- [x] 4.8 更新文档
...
- [x] 5.1 迁移 `types.rs` 到 `wp-cli-core/src/utils/types.rs`
- [x] 5.2 迁移 `fsutils.rs` 到 `wp-cli-core/src/utils/fs/`
- [x] 5.3 迁移 `stats.rs` 到 `wp-cli-core/src/utils/stats/`
- [x] 5.4 迁移 `validate.rs` 到 `wp-cli-core/src/utils/validate/`
- [x] 5.5 迁移 `banner.rs` 到 `wp-cli-core/src/utils/`
- [x] 5.6 迁移 `pretty/` 到 `wp-cli-core/src/utils/pretty/`
- [x] 5.7 更新 `wp-cli-core/src/lib.rs` 导出
- [x] 5.8 更新所有 `use` 语句
- [x] 5.9 运行测试
- [x] 5.10 提交迁移更改
